...
byte1 : mode_state, 0x6 表示关蜂鸣器、rs232/rs485输出
...
"""
PARA_ACTIVE_MODE_EPC_MEM = [0x1, 0x6, 0x1, 0x2, 0x6, 0x5]  # 主动模式的6个字节参数
PARA_ANSWER_MODE_USER_MEM = [0x0, 0x6, 0x3, 0x0, 0x0, 0x0]  # 应答模式的6个字节参数

IDENTICAL_COUNTER = 0x5
